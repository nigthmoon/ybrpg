...
const contentList = {
	...
	skill: {
		...
		skill_103: {
			name: "技能攻击",
			intro: "对一行敌人造成伤害，伤害系数为165%，65几率提升前排2000格挡两回合",
			ai_intro: "对敌方前排敌人造成伤害，伤害系数为165%，65几率提升前排2000格挡两回合",
			target: ["row", "first"],
			coefficient: 1.65,
			isRecover: false,
			emoji: "🌙",
		...
		skill_105: {
			name: "技能攻击",
			intro: "对全体造成伤害，伤害系数为105%，10%几率麻痹目标1回合",
			ai_intro: "对全体敌方造成伤害，伤害系数为105%，10%几率麻痹目标1回合",
			target: ["all", "all"],
			coefficient: 1.05,
			isRecover: false,
			emoji: "💧",
		...
		skill_106: {
			name: "技能攻击",
			intro: "对一行敌人造成伤害，伤害系数为145%，消耗10%最大生命值，增加30%伤害",//注根据推测，应为针对技能的条件增伤
			ai_intro: "对敌方后排敌人造成伤害，伤害系数为145%，消耗10%最大生命值，增加30%伤害",
			target: ["row", "last"],
			coefficient: 1.55,
			isRecover: false,
			emoji: "🌙",
		...
		skill_108: {
			name: "技能攻击",
			intro: "对一行敌人造成伤害，伤害系数为165%，50%几率封印目标1回合",
			ai_intro: "对敌方前排敌人造成伤害，伤害系数为165%，50%几率封印目标1回合",
			target: ["row", "first"],
			coefficient: 1.65,
			isRecover: false,
			emoji: "🔥",
		...
		skill_109: {
			name: "技能攻击",
			intro: "对单体造成伤害，伤害系数为325%，65%几率增加自身40格挡2回合",
			ai_intro: "对敌方前排单体造成伤害，伤害系数为325%，65%几率增加自身40格挡2回合",
			target: ["one", "first"],
			coefficient: 3.25,
			isRecover: false,
			emoji: "⛰️",
		...
		skill_110: {
			name: "技能攻击",
			intro: "对单体造成伤害，伤害系数为265%，60%几率降低目标75%被治疗效果2回合",
			ai_intro: "对血量最少的敌方造成伤害，伤害系数为265%，60%几率降低目标75%被治疗效果2回合",
			target: ["one", "lowest"],
			coefficient: 2.65,
			isRecover: false,
			emoji: "🔥",
		...
		skill_111: {
			name: "技能回复",
			intro: "治疗全体友方，系数为115%，清除负面效果",
			ai_intro: "治疗全体友方，系数为115%，清除负面效果",
			target: ["all", "all"],
			coefficient: 1.15,
			isRecover: true,
			emoji: "🧪",
		...
		skill_112: {
			name: "技能攻击",
			intro: "对一列敌人造成伤害，伤害系数为195%，55%几率降低目标45%防御2回合",
			ai_intro: "对敌方默认前排所在的一列敌人造成伤害，伤害系数为195%，55%几率降低目标45%防御2回合",
			target: ["column", "first"],
			coefficient: 1.95,
			isRecover: false,
			emoji: "🌙",
		...
		skill_113: {
			name: "技能攻击",
			intro: "对一行敌人造成伤害，伤害系数为165%，20%几率眩晕目标1回合",
			ai_intro: "对敌方前排敌人造成伤害，伤害系数为165%，20%几率眩晕目标1回合",
			target: ["row", "first"],
			coefficient: 1.65,
			isRecover: false,
			emoji: "🌪️",
		...
		skill_114: {
			name: "技能攻击",
			intro: "对单体造成伤害，伤害系数为325%，40%几率眩晕目标1回合",
			ai_intro: "对敌方前排单体造成伤害，伤害系数为325%，40%几率眩晕目标1回合",
			target: ["one", "first"],
			coefficient: 3.25,
			isRecover: false,
			emoji: "⛰️",
		...
		skill_116: {
			name: "技能攻击",
			intro: "对单体造成伤害，伤害系数为325%，100%几率提升友方后排15%攻击力2回合",//（根据目标自身的攻击力）
			ai_intro: "对敌方前排单体造成伤害，伤害系数为325%，100%几率提升友方后排15%攻击力2回合",
			target: ["one", "first"],
			coefficient: 3.25,
			isRecover: false,
			emoji: "🔥",
		...
		skill_119: {
			name: "技能攻击",
			intro: "对单体造成伤害，伤害系数为325%，100%几率封印目标1回合",
			ai_intro: "对敌方前排单体造成伤害，伤害系数为325%，100%几率封印目标1回合",
			target: ["one", "first"],
			coefficient: 3.25,
			isRecover: false,
			emoji: "🔥",
		...
		skill_202: {
			name: "技能攻击",
			intro: "对单体造成伤害，伤害系数为305%，提升全体友方1500命中2回合",
			ai_intro: "对敌方前排单体造成伤害，伤害系数为305%，提升全体友方1500命中2回合",
			target: ["one", "first"],
			coefficient: 3.05,
			isRecover: false,
			emoji: "🎵",
		...
		skill_206: {
			name: "技能攻击",
			intro: "对单体造成伤害，伤害系数为305%，30%几率减少目标1能量",
			ai_intro: "对敌方后排敌人造成伤害，伤害系数为305%，30%几率减少目标1能量",
			target: ["one", "first"],
			coefficient: 1.45,
			isRecover: false,
			emoji: "❄️",
		...
		skill_207: {
			name: "技能攻击",
			intro: "对单体造成伤害，伤害系数为305%，50%几率提升前排40%防御1回合",
			ai_intro: "对敌方前排单体造成伤害，伤害系数为305%，50%几率提升前排40%防御1回合",
			target: ["one", "first"],
			coefficient: 3.05,
			isRecover: false,
			emoji: "🌺",
		...
		skill_208: {
			name: "技能攻击",
			intro: "对一行敌人造成伤害，伤害系数为150%，100%几率令目标受到伤害增加10%，1回合",
			ai_intro: "对敌方前排敌人造成伤害，伤害系数为150%，100%几率令目标受到伤害增加10%，1回合",
			target: ["row", "first"],
			coefficient: 1.5,
			isRecover: false,
			emoji: "🌪️",
		...
		skill_211: {
			name: "技能攻击",
			intro: "对一列敌人造成伤害，伤害系数为180%，35%几率封印目标1回合",
			ai_intro: "对敌方默认前排所在的一列敌人造成伤害，伤害系数为180%，35%几率封印目标1回合",
			target: ["column", "first"],
			coefficient: 1.5,
			isRecover: false,
			emoji: "🧊",
		...
		skill_213: {
			name: "技能攻击",
			intro: "对一行敌人造成伤害，伤害系数为145%，20%几率降低目标45%防御2回合",
			ai_intro: "对敌方后排敌人造成伤害，伤害系数为145%，20%几率降低目标45%防御2回合",
			target: ["row", "last"],
			coefficient: 1.45,
			isRecover: false,
			emoji: "🌙",
		...
		skill_214: {
			name: "技能攻击",
			intro: "对三名敌人造成伤害，伤害系数为130%，25%几率降低目标20%攻击1回合",
			ai_intro: "对三名敌方能量最高的敌人造成伤害，伤害系数为130%，25%几率降低目标20%攻击1回合",
			target: ["manual_multi", "manahighest", 3],
			coefficient: 1.3,
			isRecover: false,
			emoji: "💀",
		...
		skill_215: {
			name: "技能攻击",
			intro: "对一列敌人造成伤害，伤害系数为180%，20%几率减少目标1能量",
			ai_intro: "对敌方默认前排所在的一列敌人造成伤害，伤害系数为180%，20%几率减少目标1能量",
			target: ["column", "first"],
			coefficient: 1.8,
			isRecover: false,
			emoji: "💥",
		...
		skill_216: {
			name: "技能攻击",
			intro: "对单体造成伤害，伤害系数为335%，20%几率眩晕1回合",
			ai_intro: "对敌方血量最高单体造成伤害，伤害系数为335%，20%几率眩晕1回合",
			target: ["one", "highest"],
			coefficient: 3.1,
			isRecover: false,
			emoji: "🌙",
		...
		skill_217: {
			name: "技能攻击",
			intro: "对一行敌人造成伤害，伤害系数为150%，35%几率提升前排2000格挡2回合",
			ai_intro: "对敌方前排敌人造成伤害，伤害系数为150%，35%几率提升前排2000格挡2回合",
			target: ["row", "first"],
			coefficient: 1.5,
			isRecover: false,
			emoji: "💧",
		...
		skill_218: {
			name: "技能攻击",
			intro: "对一行敌人造成伤害，伤害系数为150%，20%几率降低目标45%防御2回合",
			ai_intro: "对敌方前排敌人造成伤害，伤害系数为150%，20%几率降低目标45%防御2回合",
			target: ["row", "first"],
			coefficient: 1.5,
			isRecover: false,
			emoji: "⭐",
